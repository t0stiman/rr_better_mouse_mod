...
namespace better_mouse_mod
{
	public class Settings : UnityModManager.ModSettings
	{
		...
		public void Draw(UnityModManager.ModEntry modEntry)
		{
			...
			ThirdPersonToggleMode = GUILayout.Toggle(ThirdPersonToggleMode, "Toggle 3rd person camera movement with right click instead of holding");
			...
			if (GUILayout.Button(SelectingPauseKeyCode ? "Press key…" : PauseKeyCode.ToString(), GUILayout.ExpandWidth(false)))
			{
